...
## 1. Request Parameters  
    ...
    Date Completed:** 2020-06-03T21:01:03.034930  

    Id: 2e7ec95b-07c6-483d-ab40-778b4ea42074  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            PAN1, 36.70654, -120.812  
            PAN2, 36.70554, -120.81229  
            PAN3, 36.70000998, -120.801116  
            M3, 35.094051, -116.8349  
            M2, 34.698199, -115.684169  
            M1, 34.205676, -115.719676  
            C1, 34.84872602, -119.483117  
            C2, 34.85362197, -119.485961  
            C3, 34.93824399, -119.48084  
    
    Version: This request was processed by AppEEARS version 2.42  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - RDM-ECO4ESIPTJPL-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - RDM-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - RDM-request.json
- xml file
  - RDM-ECO4ESIPTJPL-001-metadata.xml  
...
- Hook, S., Fisher, J. (2019). ECOSTRESS Evaporative Stress Index PT-JPL Daily L4 Global 70 m V001. NASA EOSDIS Land Processes DAAC. Accessed 2020-06-03 from https://doi.org/10.5067/ECOSTRESS/ECO4ESIPTJPL.001. Accessed June 3, 2020.

## 9. Software Citation  

AppEEARS Team. (2020). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.42. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed June 3, 2020. https://lpdaacsvc.cr.usgs.gov/appeears
