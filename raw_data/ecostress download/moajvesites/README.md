...
## 1. Request Parameters  
    ...
    Date Completed:** 2020-06-04T18:03:03.987958  

    Id: e83f4674-f4b9-492b-8ac8-ac09fdf65b0c  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            M3, 35.094051, -116.8349  
            M2, 34.698199, -115.684169  
            M1, 34.205676, -115.719676  
...
- Comma-separated values file with data extracted for a specific product
  - moajvesites-ECO2LSTE-001-results.csv
- Comma-separated values file with data extracted for a specific product
  - moajvesites-ECO4ESIPTJPL-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - moajvesites-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - moajvesites-request.json
- xml file
  - moajvesites-ECO2LSTE-001-metadata.xml
- xml file
  - moajvesites-ECO4ESIPTJPL-001-metadata.xml  
...
- Hook, S., Fisher, J. (2019). ECOSTRESS Evaporative Stress Index PT-JPL Daily L4 Global 70 m V001. NASA EOSDIS Land Processes DAAC. Accessed 2020-06-04 from https://doi.org/10.5067/ECOSTRESS/ECO4ESIPTJPL.001. Accessed June 4, 2020.
- Hook, S., Hulley, G. (2019). ECOSTRESS Land Surface Temperature and Emissivity Daily L2 Global 70 m V001. NASA EOSDIS Land Processes DAAC. Accessed 2020-06-04 from https://doi.org/10.5067/ECOSTRESS/ECO2LSTE.001. Accessed June 4, 2020.

## 9. Software Citation  

AppEEARS Team. (2020). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.42.1. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed June 4, 2020. https://lpdaacsvc.cr.usgs.gov/appeears
