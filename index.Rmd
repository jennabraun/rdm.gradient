...
#trying a GAM
library(mgcv)
g1 <- gam(Species ~ Microsite * RDM, family = "poisson", data = eph)
summary(g1)
g2 <- gam(Species ~ Microsite + RDM, family = "poisson", data = eph)
summary(g2)


g1.q <- gam(Species ~ Microsite * RDM, family = "quasipoisson", data = eph)
summary(g1.q)
g1.q <- gam(Species ~ Microsite + RDM, family = "quasipoisson", data = eph)
summary(g1.q)
